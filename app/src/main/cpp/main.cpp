...
public:
    VulkanTriangle(SDL_Window* win) : window(win) {}
...
private:
    ...
    void pickPhysicalDevice() {
        ...
        if (graphicsFamily == UINT32_MAX || presentFamily == UINT32_MAX) {
            throw VulkanException("Failed to find suitable queue families!");
        }
    }
    ...
    void createSwapChain() {
        ...
        LOGI("Swap chain created: %dx%d, %u images", swapChainExtent.width, swapChainExtent.height, imageCount);
    }
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readAssetFile("vert.spv");
        auto fragShaderCode = readAssetFile("frag.spv");
    ...
    void createSyncObjects() {
        ...
        if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphore) != VK_SUCCESS ||
            ...
            throw VulkanException("Failed to create synchronization objects!");
        }
